...
class TiktokSDKApi {
  ...
  Future<void> setup(String clientKey) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.tiktok_api_android.TiktokSDKApi.setup';
  ...
  Future<TikTokLoginResult> login(List<String?> scopes, String redirectUri, bool? browserAuthEnabled) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.tiktok_api_android.TiktokSDKApi.login';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
